        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="blank-page.php"><i class="fa fa-fw fa-file"></i> My Penpals</a>
                    </li>
                    <li>
                        <a href="add-penpal.php"><i class="fa fa-fw fa-dashboard"></i> Add Penpal</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Add another penpal
                            <small>New penpal</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="blank-page.php">My Penpals</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> New penpal
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                <div class="col-lg-6">
                        <h1>Add another penpal</h1>
